...
pcrid = Ontario2018.loc[Ontario2018.First=='Conservative']
librid = Ontario2018.loc[Ontario2018.First=='Liberal']
gprid = Ontario2018.loc[Ontario2018.First=='Green Party']

ont =gv.Polygons(Ontario2018,
            vdims=['Riding',
                   'First',
                   'Conservative',
                   'NDP',
...
pc =gv.Polygons(pcrid,
            vdims=['Riding',
                   ...
                   'Green Party']
                     ...
                     width=wid,
                     height=ht,
                     color_index='Conservative',
                     cmap=pcblue
                     )
lib = gv.Polygons(librid,
            vdims=['Riding',
                   'Conservative',
                   'NDP',
                   'Liberal',
...
green = gv.Polygons(gprid,
            vdims=['Riding',
                   ...
                   'Green Party']
                     ...
                     width=wid,
                     height=ht,
                     color_index='Green Party',
                     cmap=gpgreen
                     )
ont18 = (ont * ndp * pc * lib * green)
output_file('results_18.html')
ont18
```
...
librid = Ontario2018.loc[Ontario2018.Second=='Liberal']
gprid = Ontario2018.loc[Ontario2018.Second=='Green Party']

ont = gv.Polygons(Ontario2018,
            vdims=['Riding', 'Second',  'Liberal', 'Conservative', 'NDP', 'Green Party']
           ).options(projection=projt,
                     tools=['hover'],
                     toolbar='above',
                     yaxis = None,
...
pcrid = Ontario2014.loc[Ontario2014.First=='Conservative']
librid = Ontario2014.loc[Ontario2014.First=='Liberal']

ont =gv.Polygons(Ontario2014,
            vdims=['Riding',
                   'First',
                   'Conservative',
                   'NDP',
...
ont14 = (ont * ndp * pc * lib)

output_file('results_14.html')
ont14
```
...
librid = Ontario2014.loc[Ontario2014.Second=='Liberal']
...
TO_riding_ids14 = [5, 15, 16, 17, 20, 23, 24, 25, 68, 72, 77, 80, 81, 82, 83, 84, 94,
                   95, 96, 101, 104, 106, 107]
toronto14 = Ontario2014.loc[Ontario2014.RidingID.isin(TO_riding_ids14)]
```
...
ndprid = toronto14.loc[toronto14.First=='NDP']
pcrid = toronto14.loc[toronto14.First=='Conservative']
librid = toronto14.loc[toronto14.First=='Liberal']

tor =gv.Polygons(toronto14,
            vdims=['Riding',
                   'First',
                   'Conservative',
                   'NDP',
...
output_file('tor_results_14.html')
tor14
```
...
ndprid = toronto18.loc[toronto18.First=='NDP']
pcrid = toronto18.loc[toronto18.First=='Conservative']
librid = toronto18.loc[toronto18.First=='Liberal']

tor =gv.Polygons(toronto18,
            vdims=['Riding',
                   'First',
                   'Conservative',
                   'NDP',
...
output_file('tor_results_18.html')
tor18
```
...
may14 =gv.Polygons(Mayor2014,
            vdims=['NAME', 'FORD_DOUG']).options(tools=['hover'],
                                                 width = 600,
                                                 height = 300,
                                                 color_index='FORD_DOUG',
                                                 colorbar = True,
                                                 toolbar ='above',
                                                 xaxis=None,
                                                 yaxis=None,
                                                 cmap='Blues')
output_file('tor_mayor_14.html')
may14
```
